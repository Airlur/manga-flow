...
const ArrowRightLeft = createLucideIcon("arrow-right-left", __iconNode$8);
/**
 * @license lucide-react v1.7.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function DropdownSelect({
  ...
  const dropdownContent = open ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mf-select__popover", role: "presentation", ref: popoverRef, style: popoverStyle, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mf-select__list", id: listboxId, role: "listbox", "aria-label": ariaLabel, children: options.map((option, index2) => {
    var _a;
    const selected = option.value === value;
    const previousGroup = index2 > 0 ? (_a = options[index2 - 1]) == null ? void 0 : _a.group : void 0;
...
const POPUP_SOURCE_LANGUAGE_OPTIONS = [
  { value: "ko", label: "韩语" },
  { value: "ja", label: "日语" },
  { value: "en", label: "英语" },
  { value: "zh", label: "简体中文" }
];
const POPUP_TARGET_LANGUAGE_OPTIONS = [
  { value: "ko", label: "韩语" },
  { value: "ja", label: "日语" },
  { value: "en", label: "英语" },
  { value: "zh", label: "简体中文" }
];
const POPUP_TRANSLATION_ENGINE_OPTIONS = [
...
const POPUP_OCR_ENGINE_OPTIONS = [
  { value: "local", label: "本地 OCR" },
  { value: "cloud", label: "Google Vision" }
];
const siDeepl = { path: "M20.907 4.93953 12.68543.18573a1.3577 1.3577 0 0 0-1.3709 0L3.09298 4.9565a1.3766 1.3766 0 0 0-.68639 1.18233v9.52646a1.3766 1.3766 0 0 0 .68639 1.19363l8.22157 4.75946.06223.03583 4.04856 2.3458-.01131-2.06106.0075-1.1446.0038.01885v-.38467c0-.23006.1188-.43371.29605-.56005l.264-.15086.12633-.06977h-.0075l4.80283-2.7795a1.3803 1.3803 0 0 0 .68639-1.19551V6.13505a1.3803 1.3803 0 0 0-.68642-1.19552m-9.85269 9.68863a1.4275 1.4275 0 0 1-.39976 1.3841 1.4086 1.4086 0 0 1-1.97054 0 1.4199 1.4199 0 0 1 0-2.06294 1.4086 1.4086 0 0 1 2.0422.07543l3.32822-1.91585.6864.38656zm5.77019-2.41367a1.4086 1.4086 0 0 1-1.97054 0 1.4256 1.4256 0 0 1-.3696-1.47837l-.0132.0075-3.7525-2.1723-.05657.05656a1.4086 1.4086 0 0 1-1.97053 0 1.4199 1.4199 0 0 1 0-2.06293 1.4086 1.4086 0 0 1 1.97242 0c.3941.37713.52422.91832.39033 1.40672l3.7808 2.20059.01886-.01886a1.4086 1.4086 0 0 1 1.97242 0 1.42746 1.42746 0 0 1 0 2.06105z" }, siGoogletranslate = { path: "M22.401 4.818h-9.927L10.927 0H1.599C.72 0 .002.719.002 1.599v16.275c0 .878.72 1.597 1.597 1.597h10L13.072 24H22.4c.878 0 1.597-.707 1.597-1.572V6.39c0-.865-.72-1.572-1.597-1.572zm-15.66 8.68c-2.07 0-3.75-1.68-3.75-3.75 0-2.07 1.68-3.75 3.75-3.75 1.012 0 1.86.375 2.512.976l-.99.952a2.194 2.194 0 0 0-1.522-.584c-1.305 0-2.363 1.08-2.363 2.409S5.436 12.16 6.74 12.16c1.507 0 2.13-1.08 2.19-1.808l-2.188-.002V9.066h3.51c.05.23.09.457.09.764 0 2.147-1.434 3.669-3.602 3.669zm16.757 8.93c0 .59-.492 1.072-1.097 1.072h-8.875l3.649-4.03h.005l-.74-2.302.006-.005s.568-.488 1.277-1.24c.712.771 1.63 1.699 2.818 2.805l.771-.772c-1.272-1.154-2.204-2.07-2.89-2.805.919-1.087 1.852-2.455 2.049-3.707h2.034v.002h.002v-.94h-4.532v-1.52h-1.471v1.52H14.3l-1.672-5.21.006.022h9.767c.605 0 1.097.48 1.097 1.072v16.038zm-6.484-7.311c-.536.548-.943.873-.943.873l-.008.004-1.46-4.548h4.764c-.307 1.084-.988 2.108-1.651 2.904-1.176-1.392-1.18-1.844-1.18-1.844h-1.222s.05.678 1.7 2.61z" };
const openAiLogoUrl = new URL("data:image/svg+xml,%3csvg%20viewBox='0%200%20320%20320'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='m297.06%20130.97c7.26-21.79%204.76-45.66-6.85-65.48-17.46-30.4-52.56-46.04-86.84-38.68-15.25-17.18-37.16-26.95-60.13-26.81-35.04-.08-66.13%2022.48-76.91%2055.82-22.51%204.61-41.94%2018.7-53.31%2038.67-17.59%2030.32-13.58%2068.54%209.92%2094.54-7.26%2021.79-4.76%2045.66%206.85%2065.48%2017.46%2030.4%2052.56%2046.04%2086.84%2038.68%2015.24%2017.18%2037.16%2026.95%2060.13%2026.8%2035.06.09%2066.16-22.49%2076.94-55.86%2022.51-4.61%2041.94-18.7%2053.31-38.67%2017.57-30.32%2013.55-68.51-9.94-94.51zm-120.28%20168.11c-14.03.02-27.62-4.89-38.39-13.88.49-.26%201.34-.73%201.89-1.07l63.72-36.8c3.26-1.85%205.26-5.32%205.24-9.07v-89.83l26.93%2015.55c.29.14.48.42.52.74v74.39c-.04%2033.08-26.83%2059.9-59.91%2059.97zm-128.84-55.03c-7.03-12.14-9.56-26.37-7.15-40.18.47.28%201.3.79%201.89%201.13l63.72%2036.8c3.23%201.89%207.23%201.89%2010.47%200l77.79-44.92v31.1c.02.32-.13.63-.38.83l-64.41%2037.19c-28.69%2016.52-65.33%206.7-81.92-21.95zm-16.77-139.09c7-12.16%2018.05-21.46%2031.21-26.29%200%20.55-.03%201.52-.03%202.2v73.61c-.02%203.74%201.98%207.21%205.23%209.06l77.79%2044.91-26.93%2015.55c-.27.18-.61.21-.91.08l-64.42-37.22c-28.63-16.58-38.45-53.21-21.95-81.89zm221.26%2051.49-77.79-44.92%2026.93-15.54c.27-.18.61-.21.91-.08l64.42%2037.19c28.68%2016.57%2038.51%2053.26%2021.94%2081.94-7.01%2012.14-18.05%2021.44-31.2%2026.28v-75.81c.03-3.74-1.96-7.2-5.2-9.06zm26.8-40.34c-.47-.29-1.3-.79-1.89-1.13l-63.72-36.8c-3.23-1.89-7.23-1.89-10.47%200l-77.79%2044.92v-31.1c-.02-.32.13-.63.38-.83l64.41-37.16c28.69-16.55%2065.37-6.7%2081.91%2022%206.99%2012.12%209.52%2026.31%207.15%2040.1zm-168.51%2055.43-26.94-15.55c-.29-.14-.48-.42-.52-.74v-74.39c.02-33.12%2026.89-59.96%2060.01-59.94%2014.01%200%2027.57%204.92%2038.34%2013.88-.49.26-1.33.73-1.89%201.07l-63.72%2036.8c-3.26%201.85-5.26%205.31-5.24%209.06l-.04%2089.79zm14.63-31.54%2034.65-20.01%2034.65%2020v40.01l-34.65%2020-34.65-20z'%20fill='%23111111'/%3e%3c/svg%3e", import.meta.url).href;
function SvgIcon({
  path,
  viewBox = "0 0 24 24",
  color = "currentColor"
}) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { viewBox, "aria-hidden": "true", className: "mf-popup-logo__svg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: path, fill: color }) });
}
function MicrosoftLogo() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 24 24", "aria-hidden": "true", className: "mf-popup-logo__svg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "2.5", y: "2.5", width: "8.5", height: "8.5", rx: "1.2", fill: "#f25022" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "13", y: "2.5", width: "8.5", height: "8.5", rx: "1.2", fill: "#7fba00" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "2.5", y: "13", width: "8.5", height: "8.5", rx: "1.2", fill: "#00a4ef" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "13", y: "13", width: "8.5", height: "8.5", rx: "1.2", fill: "#ffb900" })
  ] });
}
function DeeplxBadge(props) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "16.8", y: "8.5", fontSize: "5.2", fontWeight: "700", fill: "#ffffff", ...props, children: "X" });
}
function PopupProviderLogo({ provider }) {
  switch (provider) {
    case "microsoft":
      return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mf-popup-logo mf-popup-logo--microsoft", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MicrosoftLogo, {}) });
    case "google":
      return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mf-popup-logo mf-popup-logo--google", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SvgIcon, { path: siGoogletranslate.path, viewBox: "0 0 24 24", color: "#4285f4" }) });
    case "deepl":
      return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mf-popup-logo mf-popup-logo--deepl", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SvgIcon, { path: siDeepl.path, viewBox: "0 0 24 24", color: "#0f2b46" }) });
    case "deeplx":
      return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mf-popup-logo mf-popup-logo--deeplx", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 24 24", "aria-hidden": "true", className: "mf-popup-logo__svg", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: siDeepl.path, fill: "#0f2b46" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DeeplxBadge, {})
      ] }) });
    case "openai":
    default:
      return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mf-popup-logo mf-popup-logo--openai", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "mf-popup-logo__image", src: openAiLogoUrl, alt: "" }) });
  }
}
...
function PopupApp() {
  const [settings, setSettings] = reactExports.useState(() => normalizePopupSettings());
  ...
  reactExports.useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        const storedSettings = normalizeSettings(result.settings);
        const nextSettings = normalizePopupSettings(result.settings);
  ...
  const persistPartialSettings = async (partial) => {
    const result = await chrome.storage.local.get("settings");
  ...
  const withBusyAction = async (action, runner) => {
  ...
  const handleStartTranslation = async () => {
    await withBusyAction("translate", async () => {
      try {
        ...
        setBanner({ tone: "error", message: (response == null ? void 0 : response.error) || "启动翻译失败。" });
      } catch (error) {
  ...
  const handleClearCache = async () => {
    ...
    await withBusyAction("clearCache", async () => {
      try {
        ...
        if (!(response == null ? void 0 : response.success)) {
          throw new Error((response == null ? void 0 : response.error) || "清除缓存失败");
        }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "mf-popup-shell", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "mf-popup-shell__header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mf-popup-brand", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mf-popup-brand__name", children: "MANGAFLOW" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mf-popup-version", children: [
        "v",
        POPUP_VERSION
      ] })
    ] }),
    banner ? /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBanner, { tone: banner.tone, message: banner.message }) : null,
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mf-popup-language-row", "aria-label": "语言设置", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mf-popup-field mf-popup-field--language", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "mf-popup-field__label", children: "原文语言" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          DropdownSelect,
          {
            ...
            renderSelected: (option) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mf-popup-select-label", children: option.label }),
            size: "compact"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          title: "交换语言",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRightLeft, { size: 15, strokeWidth: 1.9 })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mf-popup-field mf-popup-field--language", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "mf-popup-field__label", children: "目标语言" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          DropdownSelect,
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mf-popup-control-list", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mf-popup-control-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "mf-popup-inline-label", children: "OCR" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mf-popup-inline-field", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          DropdownSelect,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mf-popup-control-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "mf-popup-inline-label", children: "翻译服务" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mf-popup-inline-field", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          DropdownSelect,
          {
            ...
            renderSelected: (option) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mf-popup-provider-copy", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(PopupProviderLogo, { provider: option.value }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mf-popup-provider-label", children: option.label })
            ] }),
            renderOptionLeading: (option) => /* @__PURE__ */ jsxRuntimeExports.jsx(PopupProviderLogo, { provider: option.value }),
            size: "compact"
          }
        ) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mf-popup-actions", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          disabled: !ready || busyAction !== null,
          children: [
            busyAction === "translate" ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mf-button__spinner", size: 16 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { size: 16, strokeWidth: 2 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "开始翻译" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mf-popup-actions__row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            ...
            disabled: !ready || busyAction !== null,
            children: [
              busyAction === "restore" ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mf-button__spinner", size: 15 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCcw, { size: 15, strokeWidth: 1.85 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "悬浮球" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            disabled: !ready || busyAction !== null,
            children: [
              busyAction === "settings" ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mf-button__spinner", size: 15 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Settings2, { size: 15, strokeWidth: 1.85 }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            disabled: !ready || busyAction !== null,
            children: [
              busyAction === "clearCache" ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mf-button__spinner", size: 15 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 15, strokeWidth: 1.8 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "清除缓存" })
            ]
          }
        )
      ] })
...
function StatusBanner({ tone, message }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `mf-banner mf-banner--${tone}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { size: 15, strokeWidth: 1.9 }),
...
if (rootElement) {
  clientExports.createRoot(rootElement).render(/* @__PURE__ */ jsxRuntimeExports.jsx(PopupApp, {}));
}
