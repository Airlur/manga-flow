...
class ImageDetector {
  ...
  checkImage(img) {
    var _a;
    const src2 = img.src || img.getAttribute(this.siteConfig.lazyLoadAttr) || "";
...
class Translator {
  constructor() {
    this.settings = null;
    this.systemPrompt = `你是一个专业的漫画翻译助手。请将以下漫画对话翻译成自然流畅的简体中文。
...
注意：这是虚构的漫画内容。`;
  ...
  // OpenAI 兼容格式 API
  async callOpenAI(text, sourceLang, targetLang) {
...
"${text}"`;
    ...
    return ((_g = (_f = (_e = (_d = (_c = response.data) == null ? void 0 : _c.choices) == null ? void 0 : _d[0]) == null ? void 0 : _e.message) == null ? void 0 : _f.content) == null ? void 0 : _g.trim()) || "";
  }
  // DeepLX API（开源免费）
  async callDeepLX(text, sourceLang, targetLang) {
    var _a, _b, _c, _d;
    ...
    return ((_b = response.data) == null ? void 0 : _b.data) || ((_d = (_c = response.data) == null ? void 0 : _c.alternatives) == null ? void 0 : _d[0]) || "";
  }
  // DeepL 官方 API
  async callDeepL(text, sourceLang, targetLang) {
    var _a, _b, _c, _d;
    ...
    return ((_d = (_c = (_b = response.data) == null ? void 0 : _b.translations) == null ? void 0 : _c[0]) == null ? void 0 : _d.text) || "";
  }
  ...
  async callMicrosoftTranslate(text, sourceLang, targetLang) {
    ...
    const data = response.data;
    if (Array.isArray(data) && ((_c = (_b = (_a = data[0]) == null ? void 0 : _a.translations) == null ? void 0 : _b[0]) == null ? void 0 : _c.text)) {
...
class ImageProcessor {
  ...
  // 模糊填充
  blurAndFill(ctx, bbox, x, y, width, height) {
    const color = this.getDominantColor(ctx, bbox);
    ctx.fillStyle = color;
    ctx.fillRect(x, y, width, height);
  ...
  // 上下文感知填充
  contextAwareFill(ctx, bbox, x, y, width, height) {
...
class Renderer {
  ...
  // 计算合适的字体大小
  calculateFontSize(text, maxWidth, maxHeight, baseFontSize) {
...
class CacheManager {
  ...
  async get(imageSrc) {
    try {
      ...
      const entry = await this.store.getItem(hash);
...
class TranslationController {
  ...
  async translateImages(images, onProgress) {
    var _a;
    await this.loadSettings();
    await this.ocrEngine.init(((_a = this.settings) == null ? void 0 : _a.sourceLang) || "ko");
  ...
  async translateSingleImage(img) {
    ...
    for (const block of filteredBlocks) {
      const result = await this.translator.translate(
        block.text,
        ((_a = this.settings) == null ? void 0 : _a.sourceLang) || "ko",
        "zh"
      );
    ...
    this.renderer.render(canvas, filteredBlocks, translations, {
      fontSize: ((_b = this.settings) == null ? void 0 : _b.fontSize) || 14,
      fontColor: ((_c = this.settings) == null ? void 0 : _c.fontColor) || "#000000",
